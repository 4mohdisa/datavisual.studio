...
import { Plus, ArrowUp, X, BarChart3, ClipboardList, MessageSquare, Loader2, Menu } from 'lucide-react';
      ...
      <div ref={messagesContainerRef} onScroll={handleScroll} className="flex-1 overflow-y-auto">
        <div className={`${COLUMN} py-6 pb-[180px] min-h-full`}>
          {uploadError ? (
            ...
            <EmptyState onFillPrompt={onFillPrompt} onAttachClick={handleAttachClick} />
          ) : (
...
function EmptyState({ onFillPrompt, onAttachClick }) {
  return (
    <div className="flex flex-col items-center justify-center text-center min-h-[70vh]">
      <h2 className="text-3xl font-semibold text-[var(--text)] mb-3">datavisual.studio</h2>
      <p className="text-base text-[var(--muted)] max-w-[460px] mb-7 leading-relaxed">
        Upload a dataset and ask anything. The council will analyse your data
